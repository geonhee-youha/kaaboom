...
import { testCelebs, testIdeas } from "../../constants/temp";
...
export default function Ideas() {
  ...
  const ideas =
    filters.length < 1
      ? testIdeas
      : _.filter(testIdeas, (el) => filters.includes(el.celeb.id));
          ...
          <Box>
            ...
            >
              ...
              >
                ...
                >
                  {lang?.toString() === "us"
                    ? `${comma(ideas.length)} results`
                    : `총 ${comma(ideas.length)}개의 결과`}
                </Typography>
              </Box>
              <Box
                sx={{
              ...
              <Box className="MainContents">
                ...
                >
                  {ideas.map((item, index) => {
                    return <IdeaItem key={index} item={item} />;
                  })}
                </Box>
              </Box>
            </Box>
